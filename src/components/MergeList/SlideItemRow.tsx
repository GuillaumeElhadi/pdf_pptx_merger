...
const styles: Record<string, React.CSSProperties> = {
  row: {
    ...
    gap: 10,
    padding: "6px 12px",
    background: "var(--bg-item-slide)",
    borderRadius: 6,
    border: "1px solid var(--border-item-slide)",
    cursor: "pointer",
    userSelect: "none",
    transition: "border-color 0.1s, background 0.1s, opacity 0.15s",
  },
  rowSelected: {
    background: "var(--bg-item-slide-selected)",
  },
  rowFollower: {
